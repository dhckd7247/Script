...
class Ui_StartWindow(object):
    ...
    def sido_select(self,Indexnum):
        global numOfRows,pageSize,pageNo,startPage,dataTerm,sidoName,sidoList,stationName,action,f,filename,tree,root,key,url,data, sidoList2, data2, url2, key2, AreaNo, tree2, root2,stateBT, f2, filename2
    ...
    def dustshow(self,Indexnum):
        global numOfRows, pageSize, pageNo, startPage, dataTerm, sidoName, sidoList, stationName, action, f, filename, tree, root, key, url, data
    ...
    def ultrashow(self, Indexnum):
        global root2, AreaNo, sidoList2, url2, data2, filename2, tree2, sidoList, root, action
        _translate = QtCore.QCoreApplication.translate
    ...
    def SendMail(self):
        global host, port, htmlFileName, senderAddr, recipientAddr, msg
        fromID, passwd, toID = ' ', ' ', ' '
